...
if ($header_transparent != 0) {
	...
	$logo			= 'https://realestate1.tegzy.com/wp-content/uploads/2023/09/Aus-Estate-logo-black-bg.svg';
	$logo_fixed		= 'https://realestate1.tegzy.com/wp-content/uploads/2023/09/Aus-Estate-logo-white-bg.svg';
} else {
			...
			<div class="nav-header">
				...
				?>
					...
					?>
						...
						<?php 
						$sticky_logo_id = resido_get_options( 'sticky-select-image' );
						$sticky_image   = wp_get_attachment_image_src($sticky_logo_id["id"], 'full');
						?>
						<a class="nav-brand fixed-logo" href="<?php echo esc_url(home_url('/')); ?>">
							<img src="<?php echo esc_url($sticky_image[0]); ?>" alt="<?php esc_attr_e('Logo', 'resido'); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>">
						</a>
					<?php
					}
				} else {
